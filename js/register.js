...
class Persona {
    constructor(nombre, apellido, direccion, departamento, correo, dni, telefono, pais, provincia,password, confirm_password) {
        this.nombre = nombre;
        ...
        this.confirm_password = confirm_password; // Corrección aquí
